...
typedef struct _objects_t {
    ...
    lv_obj_t *obj3;
    lv_obj_t *obj4;
    lv_obj_t *boton_iniciar_pausar;
    lv_obj_t *boton_salir_detener;
    lv_obj_t *obj5;
    lv_obj_t *obj6;
    lv_obj_t *obj7;
    lv_obj_t *obj8;
    ...
    lv_obj_t *obj17;
    lv_obj_t *label_iniciar_pausar;
    lv_obj_t *label_salir_detener;
    lv_obj_t *spinner_estado;
    lv_obj_t *slider_potencia;
    lv_obj_t *obj18;
    lv_obj_t *obj19;
    lv_obj_t *hora_local_1;
} objects_t;
...
enum ScreensEnum {
    ...
    SCREEN_ID_GENERAL = 2,
    SCREEN_ID_CONFIG = 3,
    SCREEN_ID_UBICACION = 4,
    SCREEN_ID_PERFIL = 5,
    SCREEN_ID_TRABAJANDO = 6,
    SCREEN_ID_FIN_SESION = 7,
};
